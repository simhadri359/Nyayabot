...
export const NyayaBotIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 3V21" /> {/* Vertical Post */}
    <path d="M5 21H19" /> {/* Base */}
    <path d="M3 7H21" /> {/* Horizontal Beam */}
    <path d="M6 7V9" /> {/* Left Hanger */}
    <path d="M18 7V9" /> {/* Right Hanger */}
    <path d="M3.5 9A2.5 2.5 0 006 11.5A2.5 2.5 0 008.5 9Z" /> {/* Left Scale */}
    <path d="M15.5 9A2.5 2.5 0 0018 11.5A2.5 2.5 0 0020.5 9Z" /> {/* Right Scale */}
  </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a59.731 59.731 0 01-4.908 0l-3.722-.537A2.121 2.121 0 013 14.894v-4.286c0-.97.616-1.813 1.5-2.097a60.133 60.133 0 0114.25 0z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM12.75 6.375a3.375 3.375 0 116.75 0 3.375 3.375 0 01-6.75 0z" />
    </svg>
);
